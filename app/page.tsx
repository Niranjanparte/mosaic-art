...
export default function Home() {
  ...
  return (
    <div>
      <h1 className="flex items-center justify-center text-4xl my-6">Mosaic Art Generator</h1>
      <div className="w-full max-w-4xl mx-auto border border-dashed bg-white dark:bg-pink-800 border-neutral-200 dark:border-neutral-800 rounded-lg">
